 ...
 * CptS 422 Homework 1
 * 
 * Purpose: This class holds the representation of a Worst-Case Boundary Values test of a triangle.
 */
package testpackage;
...
class WorstCaseBoundaryValueTest {
	...
	void testTriangleType() throws IOException {
		...
		File file = new File("WCBVTResults.txt");	//created a file object 
		...
		pw.println("-------Worst-Case Boundary Value Test------");
		...
		//Begin Worst-Case Boundary Value Test
		...
		//End Worst-Case Boundary Value Test		
		...
		pw.println();
		pw.println("--End Worst-Case Boundary Value Test--");
		pw.println(" ");
